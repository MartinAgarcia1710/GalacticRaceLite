...
int main(){
    ...
    std::cout << "ACTUALIZACION A 25 DE JUNIO DE 2024: EL JUEGO SE ENCUENTRA EN MODIFICACIONES DE BUGS QUE SE ENCONTRARON Y SE ESTA MEJORANDO LA VISUAL CON LIBRERIAS EXTERNAS. SE ENCUENTRA EN REPOSITORIO LOCAL AUN\n";
